...
export const metadata: Metadata = {
  ...
  title: "Kahil Barber Studio | Premium Barber Demo",
  description:
    "A premium booking-focused barber shop demo website by MASNRY.",
  openGraph: {
    title: "Kahil Barber Studio",
    description:
      "Luxury barber shop demo with pricing, reviews, gallery, social links, map, and booking flow.",
    type: "website"
  }
};
